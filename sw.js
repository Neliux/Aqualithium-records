const CACHE='swim-quest-final-20260918-7';
...
function patchGame(text){
  ...
  if(!out.includes('src="./final-fixes.js')){
    out=out.replace('</body>','<script src="./workout-clan-fix.js?v=20260917-1"></script><script src="./final-fixes.js?v=20260918-7"></script></body>');
  }
  return out;
}
