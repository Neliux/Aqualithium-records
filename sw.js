const CACHE='swim-quest-final-20260920-05';
const ASSETS=[
  './',
  './index.html',
...
function patchGame(text){
  ...
  if(!out.includes('src="./final-fixes.js')){
    out=out.replace(
      '</body>',
      '<script src="./workout-clan-fix.js?v=20260917-1"></script><script id="swq-sw-final-fixes" src="./final-fixes.js?v=20260920-05"></script></body>'
    );
  }
  return out;
}
